...
const iconNavItems: IconNavItem[] = [
    ...
    { icon: TrendingUp, label: "Shop 99", href: "pages/trending" },
    { icon: Cpu, label: "Recommended", href: "#" },
    { icon: Map, label: "Grocery", href: "#" },
    { icon: FileText, label: "Puja", href: "pages/about-us" },
];
...
{/* fixed */}
            <header className=" w-full fixed  top-1 z-[20] bg-black/10   backdrop-blur-md text-black shadow-md rounded-3xl mb-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="pt-2">
                            <div className="leading-[20px]">
                                <h1 className="text-[28px] font-bold font-sans">SWEAP</h1>
                                <p className="pt-[1px] text-[10px] font-sans pl-[2px]">Buy Original at Original</p>
                            </div>
                        </div>
                    </div>
</Link>
...
<br/>
{/* fixed w */}
   {/* <div className="w-full fixed top-[80px] z-[19] bg-white/90 border-b border-gray-200  hidden md:block">
